...
|---|---:|---|---|
| 毛泽东智慧 Skill | `79.0/100`, Grade `B` | imported runtime evidence, judge disabled | 来源、原则、框架和边界设计完整，但 runtime 证据来自导入对话，尚未完成完整自动 judge 复评。见 [initial evaluation](evaluations/mao-zedong/initial-evaluation.md) 与 [runtime evaluation](evaluations/mao-zedong/runtime-evaluation.md)。 |
...
- 毛澤東 Skill：靜態評測 `79.0/100`，runtime 為 imported evidence，尚未完成完整自動 judge 複評。
...
|---|---:|---|---|
| Mao Zedong Wisdom Skill | `79.0/100`, Grade `B` | imported runtime evidence, judge disabled | Source, principle, framework, and boundary design are present, but runtime evidence is imported and has not received a full automated judge rerun. See [initial evaluation](evaluations/mao-zedong/initial-evaluation.md) and [runtime evaluation](evaluations/mao-zedong/runtime-evaluation.md). |
